...
import kgs.com.openglintro.effectsRenderer.EffectTextureCallbacks;
...
public class GLSurfaceRenderView extends GLSurfaceView implements IRenderView {
    ...
    public GLSurfaceRenderView(Context context, IMediaPlayer mediaPlayer) {
        super(context);
...
//    }
    ...
    public void setRegularEffect(Grey effect) {
        this.regular = effect;
        initRegularEffect(effect);
        setRenderer(effect);
    }

    private void initRegularEffect(Grey effect) {
        effect.setEffectTextureCallbacks(new EffectTextureCallbacks() {
            @Override
            public void onSuraceTextureCreated(SurfaceTexture surfaceTexture) {
            ...
            @Override
            public void onSurfaceUpdate(SurfaceTexture surfaceTexture) {
//                if(mediaPlayer != null) {
//                    mediaPlayer.setSurface(new Surface(surfaceTexture));
//                    mediaPlayer.setScreenOnWhilePlaying(true);
//                }
    ...
    public IRenderView.ISurfaceHolder getSurfaceHolder() {
        return  new GLSurfaceRenderView.InternalSurfaceHolder(this, getHolder());
    }
